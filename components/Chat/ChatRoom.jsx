...
const ChatRoom = () => {
	...
	const FAST_API_URI = 'https://4ee9-103-139-4-166.ngrok-free.app';
    useEffect(() => {
        initializeChat();
    }, []);
                ...
                if (messageList && messageList.length > 0) {
                    ...
                    if (lastMessageObject && lastMessageObject.content) {
                        const parsedContent = JSON.parse(
                            lastMessageObject.content.trim()
                        );
    ...
    const handleChatInteraction = async () => {
        try {
            ...
            if (response.status === 200) {
                ...
                const lastMessage =
                    data.message_list[data.message_list.length - 1];
